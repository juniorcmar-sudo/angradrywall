    ...
    >
      ...
      <div className="border-t border-sidebar-border p-2 space-y-0.5">
        ...
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium text-sidebar-foreground/30 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-all"
        >
          {collapsed
            ? <ChevronRight className="flex-shrink-0 w-[18px] h-[18px]" />
            : <ChevronLeft className="flex-shrink-0 w-[18px] h-[18px]" />
          }
